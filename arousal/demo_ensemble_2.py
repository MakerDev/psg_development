...
def main(edf_path, excel_path=None, save_path=None, mode="union"):
    ...
    spec_preds, y_target, spec_probs = evaluate_spec_model(edf_path, device, save_path)

    print("\nEvaluating Time Model...")
    time_preds, _, time_probs = evaluate_time_model(edf_path, device, save_path)
